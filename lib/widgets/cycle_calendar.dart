...
class _DayCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusColor = switch (status) {
      DayStatus.period => AppColors.rose,
      DayStatus.predictedPeriod => AppColors.predicted,
      DayStatus.fertile => AppColors.fertile,
      DayStatus.ovulation => AppColors.ovulation,
    ...
    final foreground = selected
        ...
        : inMonth
            ? AppColors.ink
            : AppColors.muted.withOpacity(0.42);
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: today && !selected
                ? Border.all(color: AppColors.rose, width: 1.2)
                : null,
          ),
          child: Column(
  ...
  Widget build(BuildContext context) {
    return const Wrap(
      ...
      children: [
        ...
        _LegendItem(color: AppColors.lavender, label: 'Logged'),
      ],
    );
  }
}
